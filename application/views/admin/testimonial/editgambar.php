      ...
      <div class="row">
                          ...
                          <div class="box">
                            <div class="box-header with-border">
                              <h3 class="box-title">Page Testimoni</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <?php foreach($detail_testimoni as $row ): ?>
                            <form role="form">
                                <div class="box-body">
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('testimonial/proseseditgambar')?>">
                              <div class="box-body">
                                  <div class="form-group">

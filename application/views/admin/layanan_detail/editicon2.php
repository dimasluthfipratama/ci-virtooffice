                            ...
                            <form role="form">
                                <div class="box-body">
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                          <img src="<?php echo base_url('upload/'.$row->icon2);?>" style="width:600px;" >
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <?php endforeach; ?>
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('layanan_detail/prosesediticon2')?>">
                              <div class="box-body">

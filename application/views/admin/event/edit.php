    ...
    <section class="content">
      ...
      <div class="row">
                          ...
                          <div class="box">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <?php foreach($detail_event as $row ): ?>
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('event/prosesedit')?>">
                              <div class="box-body">
                                  <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Name</label>
                                    <div class="col-sm-10">
                                      <input type="hidden" class="form-control" id="id_event" name="id_event" readonly="" value="<?php echo $row->id_event; ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" name="tema" id="tema"  value="<?php echo $row->tema; ?>">
                                    </div>
                                  </div>
                                  <div class="form-group">

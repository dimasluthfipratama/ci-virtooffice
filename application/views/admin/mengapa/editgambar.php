    ...
    <section class="content">
      ...
      <div class="row">
                          ...
                          <div class="box">
                            ...
                            <?php endforeach; ?>
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('mengapa/proseseditgambar')?>">
                              <div class="box-body">
                                ...
                                <?php foreach($detail_mengapa as $row ): ?>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="hidden" class="form-control" id="id_services" name="id" readonly="" value="<?php echo $row->id_mengapa; ?>">

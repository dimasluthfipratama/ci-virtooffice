...
<meta name="description" content="Solusi Hemat untuk Bisnis Anda">
<meta name="keyword" content="sewa kantor surabaya, sewa ruang kantor surabaya">
...
<!-- Document Title
============================================= -->
<title>Meeting Room Surabaya | Virto Office (031) 596 7623 </title>
</head>
<body>
<div class="preloader">
	<div class="spinner">
			...
			<div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-left">
						<li class="has-dropdown active">
							<a href="<?php echo base_url();?>" data-toggle="dropdown" class="dropdown-toggle">Beranda</a>
						</li>
						<!-- li end -->
						<li class="has-dropdown">
							<a href="<?php echo base_url();?>" data-toggle="dropdown" class="dropdown-toggle">Tentang Kami</a>
						</li>
						<!-- li end -->
						<li class="has-dropdown">
							<a href="<?php echo base_url();?>" data-toggle="dropdown" class="dropdown-toggle">Layanan</a>
						</li>
						<!-- li end -->
						<li class="has-dropdown pull-left">
							<a href="<?php echo base_url();?>" data-toggle="dropdown" class="dropdown-toggle">Kontak</a>
						</li>
						<!-- li end -->
						<li class="has-dropdown pull-left">
							<a href="<?php echo base_url();?>" data-toggle="dropdown" class="dropdown-toggle">Galeri</a>
						</li>
						<!-- li end -->
						<li class="has-dropdown">
							<a href="http://sewakantorsurabaya.com/blog" data-toggle="dropdown" class="dropdown-toggle">Artikel</a>
						</li>
						<!-- li end -->
						<li class="has-dropdown pull-left">
							<a href="<?php echo base_url('promo');?>" data-toggle="dropdown" class="dropdown-toggle">PROMO</a>
						</li>
						<!-- li end -->
				</ul>
...
<section class="bg-overlay bg-overlay-gradient pb-0">
	<div class="bg-section" >
		<img src="upload/covermeeting.jpg" alt="Background"/>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="page-title title-1 text-center">
					<div>
						<h2>Paket Hemat Untuk Event Anda</h2>
					</div>
					<ol class="breadcrumb">
						<li>
...
<!-- Service Block #3
============================================= -->
<section id="service-3" class="service service-3 bg-gray">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
				<div class="heading heading-2 text-center">
					<div>
						<h2>Mengapa Memilih Ruang Pertemuan di Virto</h2>
					</div>
				</div>
				<!-- .heading end -->
			</div>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						<div class="service-img">
							...
							<img src="assets/images/services/icons/i48/1.png" alt="icons"/>
						</div>
						<div class="service-content">
							<div class="service-desc">
								<h4>Tersedia Per 4 Jam</h4>
								<p> Sewa ruang pertemuan per jam sesuai kebutuhan.	 </p>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						<div class="service-img">
							...
							<img src="assets/images/services/icons/i48/2.png" alt="icons"/>
						</div>
						<div class="service-content">
							<div class="service-desc">
								<h4>Ruang yang dapat disesuaikan</h4>
								<p> Ubah tata letak ruangan sesuai tujuan rapat. </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						<div class="service-img">
							...
							<img src="assets/images/services/icons/i48/3.png" alt="icons"/>
						</div>
						<div class="service-content">
							<div class="service-desc">
								<h4>Cara pemesanan mudah</h4>
								<p> Gunakan aplikasi kami untuk memesan ruang rapat dengan cepat – tidak perlu menelepon.</p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						<div class="service-img">
							...
							<img src="assets/images/services/icons/i48/4.png" alt="icons"/>
						</div>
						<div class="service-content">
							<div class="service-desc">
								<h4>Siap pakai</h4>
								<p> Ruangan sudah diatur ketika Anda tiba. </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
...
<!-- Service Block #5
============================================= -->
<section id="service-5" class="service service-5">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
				<div class="heading heading-2 text-center">
					<div >
				 	    <h2>Paket Smart</h2>
						<p>Pilih Ruang Sesuai Kebutuhan Anda</p>
					</div>
				</div>
				<!-- .heading end -->
			</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 col-md-4 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Paket 75rb / Pax</h4>
								<p>Air Mineral</p>								
								<p>1x Coffee Break & Snack</p>								
								<p>4 Jam</p>								
								<p>Minimal 5 Pax</p>
								<a class="read-more" href="#"><i class="fa fa-plus"></i>
									<span>DAPATKAN PENAWARAN</span>
					...
					<div class="col-xs-12 col-sm-4 col-md-4 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Paket 125rb / Pax</h4>
								<p>2x Air Mineral</p>								
								<p>2x Coffee Break & Snack</p>								
								<p>8 Jam</p>								
								<p>Minimal 5 Pax</p>
								<a class="read-more" href="#"><i class="fa fa-plus"></i>
									<span>DAPATKAN PENAWARAN</span>
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="heading heading-3 mb-0 text-center">
					<div class="heading-bg">
						<h2>Contoh Layout Penataan Ruang Pertemuan</h2>
					</div>
				</div>
				<!-- .heading end -->
			</div>
		...
		<div id="projects-all" class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item interior">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (1).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (1).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item interior gardening">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (2).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (2).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item renovation landscaping">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (3).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (3).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item interior landscaping">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (4).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (4).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item architecture">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (5).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (5).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item interior">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (6).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (6).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item interior">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (7).jpg" width="350" height="auto"  alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (7).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 project-item interior">
				<div class="project-img">
					<img class="" src="upload/sewa-meeting (8).jpg" width="350" height="auto"  alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/sewa-meeting (8).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
				<h2 class="mb-xs">Mari Kita Mulai !</h2>
				<p class="mb-50"> Apa pun bisnis Anda, apa pun anggaran Anda kami akan membantu menemukan ruang kerja yang tepat.</p>
				<a class="btn btn-primary btn-black" href="#" data-toggle="modal" data-target="#model-quote2">Dapatkan Penawaran</a>
				<!-- Modal -->
				<div class="modal fade model-quote" id="model-quote2" tabindex="-1" role="dialog" aria-labelledby="modelquote">

...
<!-- Document Title
============================================= -->
<title>Coworking Space | Virto Office (031) 596 7623 </title>
</head>
<body>
<div class="preloader">
	<div class="spinner">
...
<section class="bg-overlay bg-overlay-gradient pb-0">
	<div class="bg-section" >
		<img src="upload/covercoworking.jpg" alt="Background"/>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="page-title title-1 text-center">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Coworking Space</li>
					</ol>
				</div>
				<!-- .page-title end -->
			</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
				<div class="heading heading-2 text-center">
					<div>
						<h2>Mengapa Memilih Coworking Space di Virto</h2>
					</div>
				</div>
				<!-- .heading end -->
			</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Banyak Colokan Listrik</h4>
								<p> Tidak perlu khawatir kehabisan baterai </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Utilities Office</h4>
								<p> Butuh untuk cetak dokumen anda</p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Book Corner</h4>
								<p> Tingkatkan ilmu pengetahuan dengan membaca buku. </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Area Lesehan</h4>
								<p>Capek kerja di meja. terdapat area lesehan yang nyaman </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Snack Corner</h4>
								<p>Cemilan enak di virto office. </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Musholla</h4>
								<p>Terdapat Musholla di lantai 2. </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 service-block">
						...
						<div class="service-content">
							<div class="service-desc">
								<h4>Parkir Gratis dan Luas</h4>
								<p>Tidak perlu mengeluarkan biaya tambahan untuk parkir. </p>
							</div>
						</div>
					</div>
					<!-- .col-md-3 end -->
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
				<div class="heading heading-2 text-center">
					<div class="heading-bg">
						<h2> Pilih Paket Sesuai Kebutuhan Anda </h2>
					</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12 price-table">
				<div class="panel">
					...
					<ul class="list-group">
						<li class="list-group-item text-capitalize">Sewa Harian</li>
						<li class="list-group-item text-capitalize">Hanya 25 Ribu</li>
						<li class="list-group-item text-capitalize">Coworking Space</li>
						<li class="list-group-item text-capitalize">Free Hot Drink</li>
					</ul>
					<!--  Packge Footer  -->
					<div class="panel-footer">
						<a class="btn btn-secondary btn-block " href="#">Hubungi Kami <i class="fa fa-plus ml-xs"></i></a>
					</div>
				</div>
			</div>
			<!-- Package End -->
			...
			<div class="col-md-4 col-sm-4 col-xs-12 price-table">
				<div class="panel">
					...
					<ul class="list-group">
					<li class="list-group-item text-capitalize">Sewa Bulanan</li>
					<li class="list-group-item text-capitalize">Hanya 375 Ribu</li>
					<li class="list-group-item text-capitalize">Coworking Space</li>
					</ul>
					<!--  Packge Footer  -->
					<div class="panel-footer">
			...
			<div class="col-md-4 col-sm-4 col-xs-12 price-table">
				<div class="panel">
					...
					<ul class="list-group">
					<li class="list-group-item text-capitalize">Sewa Minimal 12 Bulan</li>
					<li class="list-group-item text-capitalize">Hanya 300 Ribu per bulan</li>
					<li class="list-group-item text-capitalize">Coworking Space</li>
					<li class="list-group-item text-capitalize">Paket Virtual Office</li>
					</ul>
					<!--  Packge Footer  -->
					<div class="panel-footer">
						<a class="btn btn-secondary btn-block " href="#">Hubungi Kami <i class="fa fa-plus ml-xs"></i></a>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="heading heading-3 mb-0 text-center">
					<div class="heading-bg">
						<h2>Galeri Coworking Virto Office</h2>
					</div>
				</div>
				<!-- .heading end -->
			</div>
		...
		<div id="projects-all" class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-3 project-item interior">
				<div class="project-img">
					<img class="" src="upload/cowokringspacevirto (1).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/cowokringspacevirto (1).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 project-item interior gardening">
				<div class="project-img">
					<img class="" src="upload/cowokringspacevirto (2).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/cowokringspacevirto (2).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 project-item renovation landscaping">
				<div class="project-img">
					<img class="" src="upload/cowokringspacevirto (3).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/cowokringspacevirto (3).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 project-item interior landscaping">
				<div class="project-img">
					<img class="" src="upload/cowokringspacevirto (4).jpg" width="350" height="auto" alt="interior"/>
					<div class="project-hover">
						<div class="project-meta">
							<h6>Interior</h6>
							<h4>
						...
						<div class="project-zoom">
							<a class="img-popup" href="upload/cowokringspacevirto (4).jpg" title="New Office Room"><i class="fa fa-plus"></i></a>
						</div>
					</div>
					<!-- .project-hover end -->
				</div>
